    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if ('ok' == result.status) {
                ...
                setTimeout(function() {
                    window.location.href = '/menu/general/';
                }, 1000);
            }
        },
        complete: function() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if ('ok' == result.status) {
                $.notify(result.text, "success");
                setTimeout(function() {
                    window.location.href = '/menu/general/manage?id=' + form.find('input[name="id"]').val();
                }, 1000);
            }
        },
        complete: function() {
